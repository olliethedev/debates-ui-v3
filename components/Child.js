...
const Child = ({className, post}) => {
    return (
        <div className="md:max-w-min bg-white p-2 h-auto rounded-2xl shadow flex flex-col gap-5 select-none mb-4 md:mr-4 sm:mx-auto">
            <div
                className="h-52 md:w-80 rounded-xl bg-gray-100 bg-center bg-cover"
            ...
            <div className="flex flex-col gap-2 p-1">
                ...
                <p className="text-gray-500 text-sm sm:text-base line-clamp-3 overflow-ellipsis">
                {post.content}{post.content}{post.content}{post.content}{post.content}{post.content}
                {post.content}{post.content}adfadsfasdf asd a dfasd a a a dfads fasdf as das das asasdf as fas ds as da
                </p>
